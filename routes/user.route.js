...
const { registerController, loginController, getUserProfileController, logoutController, updateProfileController, updateUserPassword } = require("../controllers/user.controller.js");
